...
const Landing = () => {
  return (
    <div className="flex flex-col font-epilogue text-center items-center">
        ...
        <button className="bg-almost-black text-almost-white px-4 py-2 mt-4 rounded-xl">Learn More</button>
        <div className="flex justify-center  mt-10 gap-4 w-full mx-8">
